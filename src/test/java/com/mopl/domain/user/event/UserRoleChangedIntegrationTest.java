...
@DisplayName("UserRoleChangedEventListener 단위 테스트")
class UserRoleChangedIntegrationTest {
    ...
    @Test
    @DisplayName("권한 변경 이벤트를 받아 알림 요청 이벤트를 발행한다")
    ...
    @Test
    @DisplayName("권한 변경 이벤트를 받으면 기존 세션을 강제 로그아웃시킨다")
